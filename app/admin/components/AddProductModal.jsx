  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 sm:mx-6 md:mx-8 lg:mx-auto border-t-4 border-yellow-500"
      >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="block w-full appearance-none rounded-lg border border-gray-300 px-3 sm:px-4 py-2 sm:py-3 text-gray-900 focus:border-yellow-500 focus:ring-yellow-500 focus:outline-none transition-colors pr-10"
                    required
                  >
